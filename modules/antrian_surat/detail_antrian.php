            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ml-auto">
                            <span
                                class="badge <?php echo ($days_waiting >= 7) ? 'badge-danger' : (($days_waiting >= 3) ? 'badge-warning' : 'badge-success'); ?>">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($data['judul_surat']); ?></td>
                                </tr>
                                <tr>
                        ...
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                <tr>
                                    <td width="40%"><strong>Pengaju:</strong></td>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo ceil($days_waiting); ?> hari</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    <?php if (!empty($data['perihal'])): ?>
                        <div class="mt-3">
                            ...
                            <div class="bg-light p-3 mt-2 rounded"><?php echo nl2br(htmlspecialchars($data['perihal'])); ?>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="nav nav-pills mb-3" id="signatureTab" role="tablist">
                        <li class="nav-item"><a class="nav-link active" id="draw-tab" data-toggle="tab" href="#draw"
                                role="tab">Gambar</a></li>
                        <li class="nav-item"><a class="nav-link" id="upload-tab" data-toggle="tab" href="#upload"
                                role="tab">Upload</a></li>
                        <li class="nav-item"><a class="nav-link" id="saved-tab" data-toggle="tab" href="#saved"
                                role="tab">Riwayat</a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="draw" role="tabpanel">
                            <canvas id="signatureCanvas" width="300" height="150"
                                style="border: 2px solid #dee2e6; border-radius: 10px; background: white;"></canvas>
                            <button class="btn btn-secondary btn-block mt-2" id="clearCanvas"><i
                                    class="fas fa-eraser mr-2"></i>Bersihkan</button>
                        </div>
                        <div class="tab-pane fade" id="upload" role="tabpanel">
                            <input type="file" id="signatureFile" accept="image/*" style="display: none;">
                            <button class="btn btn-info btn-block" id="uploadImageBtn">📁 Pilih Gambar Tanda
                                Tangan</button>
                            <div id="uploadPreview" class="mt-2" style="display: none; text-align: center;">
                                <img id="uploadedSignature" src="" alt="Uploaded Signature"
                            ...
                            <div class="row">
                                <?php foreach ($riwayat_ttd as $ttd): ?>
                                    <div class="col-6 mb-2 text-center">
                                        <img src="<?php echo htmlspecialchars($ttd); ?>" class="img-fluid saved-signature"
                                            data-path="<?php echo htmlspecialchars($ttd); ?>"
                                            style="max-height: 80px; border: 1px solid #ddd; cursor: pointer;">
                                    </div>
                                <?php endforeach; ?>
                            </div>
                        </div>
                    ...
                    <form id="approvalForm" method="POST">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <textarea class="form-control" id="catatanPimpinan" name="catatan_persetujuan"
                                rows="3"></textarea>
                        </div>
                        <button type="button" class="btn btn-primary btn-block mt-3" id="selectAreaBtn"><i
                                class="fas fa-arrows-alt mr-2"></i>Pilih Area Tanda Tangan</button>
                        <button type="button" class="btn btn-success btn-block mt-2" id="btnSetujui" disabled><i
                                class="fas fa-check mr-2"></i>Setujui & Tandatangani</button>
                        <button type="button" class="btn btn-danger btn-block mt-2" data-toggle="modal"
                            data-target="#rejectModal"><i class="fas fa-times mr-2"></i>Tolak</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tolak Pengajuan</h5><button type="button" class="close"
            ...
            <form method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="catatanPenolakan" name="catatan_penolakan" rows="4"
                            required></textarea>
                    </div>
                </div>
...
<style>
    ...
    .pdf-page-wrapper {
        ...
        /* Halaman di tengah, dengan jarak bawah */
        display: block;
        width: fit-content;
    }
