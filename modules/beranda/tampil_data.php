    ...
    <div class="page-inner mt--5">
        <div class="row row-card-no-pd align-items-center p-2 p-sm-4">
            ...
            <div class="col-lg-9 heroes-text px-xl-5">
                <h2 class="text-success mb-2">Selamat datang kembali <span><?php echo $_SESSION['nama_user']; ?></span> di
                    <span> Website <?php echo $data['nama']; ?></span>
                </h2>
                <h4 class="text-muted mb-4">Dashsboard Kerja adalah Sistem Informasi Monitoring dan juga antarmuka atau alat
                    digital yang dirancang untuk memberikan informasi komprehensif tentang berbagai aspek pekerjaan,
                    kinerja, dan informasi dalam bentuk visualisasi.</h4>
            </div>
        </div>
        ...
        if (in_array($_SESSION['hak_akses'], ['SuperAdmin', 'BUIB', 'Pimpinan', 'SekretarisPimpinan', 'BKS', 'BKI', 'TrainingCenter', 'LEMTERA', 'PusatBisnis', 'ManajerBKS', 'ManajerBKI','ManajerLemtera','ManajerTC', 'ManajerBUIB'])) { ?>
            <div class="row mt-5">
                ...
                render_menu_card('Training Center', 'training_center', 'fas fa-chalkboard-teacher', 'tomato', $_SESSION['hak_akses']);
                ?>
            </div>
            <?php
        } else { ?>
