...
// jika file di include oleh file lain, tampilkan isi file
    ...
    <div class="panel-header">
        <div class="page-inner py-4">
            <div class="page-header">
                <!-- judul halaman -->
                <h4 class="page-title"><i class="fas fa-folder-open mr-2"></i>Jenis Dokumen</h4>
                <!-- breadcrumbs -->
    ...
    <div class="page-inner mt--5">
        <div class="card">
            ...
            <!-- form ubah data -->
            <form action="modules/arsip/proses_ubah.php" method="post" enctype="multipart/form-data"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group col-lg-4">
                        ...
                        <select name="jenis_dokumen" class="form-control select2-single" autocomplete="off" required>
                            <option value="<?php echo $data['jenis_dokumen']; ?>"><?php echo $data['nama_jenis']; ?>
                            </option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 pr-lg-0">
                            <div class="form-group">
                                ...
                                <input type="text" name="tahun" class="form-control" maxlength="4" autocomplete="off"
                                    onKeyPress="return goodchars(event,'0123456789',this)" value="<?php echo $tahun; ?>"
                                    required>
                    ...
                    <div class="row">
                        <div class="col-lg-2 pr-lg-0">
                            <div class="form-group">
                                ...
                                <input type="text" name="tahun_anggaran" class="form-control" maxlength="4"
                                    autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)"
                                    value="<?php echo $data['tahun_anggaran']; ?>" required>
                    ...
                    <div class="form-group col-lg-4">
                        ...
                        <a href="?module=tampil_detail_arsip&id=<?php echo $data['id_arsip']; ?>"><i
                                class="far fa-file-alt fa-8x text-warning mt-3 mb-2"></i></a>
