...
if (isset($_POST['simpan'])) {
    ...
    $query = mysqli_query($mysqli, "INSERT INTO tbl_pks(mitra_id, pic_bagian_id, no_dokumen, tentang, tanggal_penandatanganan, jangka_waktu_tahun, link_dokumen_pks)
                                     VALUES('$mitra_id', '$pic_bagian_id', '$no_dokumen', '$tentang', '$tanggal_penandatanganan', '$jangka_waktu_tahun', '$link_dokumen_pks')")
