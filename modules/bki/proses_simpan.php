...
if (empty($_SESSION['username']) && empty($_SESSION['password'])) {
    ...
    if (isset($_POST['simpan_realisasi'])) {
        ...
        $cek_data = mysqli_query($mysqli, "SELECT id FROM tbl_rk_bki 
        ...
        $insert = mysqli_query($mysqli, "INSERT INTO tbl_rk_bki (
                                            nama_program,
                                            keterangan_program, 
                                            target_nominal, 
                                            realisasi_nominal, 
