...
// jika file di include oleh file lain, tampilkan isi file
	...
	if (in_array($_SESSION['hak_akses'], ['SuperAdmin', 'BUIB', 'Pimpinan', 'SekretarisPimpinan', 'BKI', 'BKS'])) { ?>
		<div class="panel-header">
			<div class="page-inner py-45">
				<div class="d-flex align-items-left align-items-md-top flex-column flex-md-row">
					<div class="page-header">
						<!-- judul halaman -->
						<h4 class="page-title"><i class="fas fa-folder-open mr-2"></i>Mitra Internasional</h4>
						<!-- breadcrumbs -->
						<ul class="breadcrumbs">
							...
							<li class="separator"><i class="flaticon-right-arrow"></i></li>
							<li class="nav-item"><a>Mitra</a></li>
						</ul>
					</div>
					<div class="ml-md-auto py-2 py-md-0">
						<!-- button tambahkan mitra -->
						<a href="#" class="btn btn-success btn-round" data-toggle="modal" data-target="#modalTambah"
							...
							<i class="fa fa-plus mr-2 text-regular"> Tambahkan Mitra Baru</i>
						</a>
						<!-- modal tambahkan mitra -->
						<div class="modal fade" id="modalTambah" tabindex="-1" role="dialog" aria-labelledby="modalEditLabel"
							aria-hidden="true">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<form action="modules/bki/mitra_bki/proses_simpan.php" method="post">
										...
										<div class="modal-body">
											...
											<div class="form-group">
												...
												<input type="text" name="nama_mitra" class="form-control" value="">
											</div>
											<!-- bagian Ubah Kode Singkat -->
											<div class="form-group">
												<label>Asal Negara</label>
												<input type="text" name="negara" class="form-control" value="">
											</div>
											<!-- bagian Ubah Kode Singkat -->
											<div class="form-group">
												<label>Alamat</label>
		...
		<div class="page-inner mt--5">
			<div class="card">
				<div class="card-header">
					<!-- judul tabel -->
					<div class="card-title">Daftar Mitra BKI</div>
				</div>
				<div class="card-body">
					<div class="table-responsive">
						...
						<table id="basic-datatables" class="display table table-bordered table-striped table-hover">
							...
							<tbody>
								...
								$query = mysqli_query($mysqli, "SELECT * FROM tbl_mitra_bki;")
								...
								while ($data = mysqli_fetch_assoc($query)) {
									...
									<tr>
										...
										<td width="80"><?php echo $data['nama_mitra']; ?></td>
										...
										<td width="80" class="text-center">
											<div>
												...
												<div class="modal fade" id="modalUbah<?php echo $data['id']; ?>" tabindex="-1"
													...
													<div class="modal-dialog" role="document">
														<div class="modal-content">
															<form action="modules/bki/mitra_bki/proses_ubah.php" method="post">
																<div class="modal-header">
																...
																<div class="modal-body">
																	...
																	<!-- Form Input Mitra -->
																	<div class="form-group">
																		<label>Mitra Internasional</label>
																		<input type="text" name="nama_mitra" class="form-control"
																			value="<?php echo htmlspecialchars($data['nama_mitra']); ?>">
																	</div>

																	<!-- bagian Ubah Asal Negara -->
																	<div class="form-group">
																		<label>Asal Negara</label>
																		<input type="text" name="negara" class="form-control"
																			value="<?php echo htmlspecialchars($data['negara']); ?>">
																	</div>

																	<!-- bagian Ubah Alamat mitra -->
																	<div class="form-group">
																		<label>Alamat</label>
