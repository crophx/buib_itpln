...
if (isset($_POST['simpan_rencana'])) {
    ...
    $tentang = mysqli_real_escape_string($mysqli, trim($_POST['keterangan']));
    ...
    $query = mysqli_query($mysqli, "INSERT INTO tbl_rk_bks(mitra_id, bentuk_kerjasama, tentang, target_realisasi) 
                                     VALUES('$mitra_id', '$bentuk_kerjasama', '$tentang', '$target_realisasi')")
