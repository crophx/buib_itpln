...
// jika file di include oleh file lain, tampilkan isi file
    ...
    function filterData(tahun, program) {
        ...
        filteredData.forEach(item => {
            ...
            // Monthly data (non-cumulative for realisasi, kontrak, ongoing)
        ...
        // Hitung monthly target (non-cumulative, hanya totalTarget / 12 untuk setiap bulan)
        const monthlyAccumulative = {};
        const monthlyTarget = totalTarget / 12; // Target bulanan adalah total tahunan dibagi 12
        
        Object.keys(filteredMonthlyData).sort().forEach(bulan => {
            monthlyAccumulative[bulan] = {
                label: filteredMonthlyData[bulan].label,
                target: monthlyTarget, // Non-kumulatif, hanya totalTarget / 12
                realisasi: filteredMonthlyData[bulan].realisasi, // Non-kumulatif
                terkontrak: filteredMonthlyData[bulan].kontrak, // Non-kumulatif
                ongoing: filteredMonthlyData[bulan].ongoing // Non-kumulatif
            };
        });
    ...
    function updateLineChart(monthlyAccumulative) {
        ...
        lineChart = new Chart(document.getElementById('lineChart'), {
            ...
            options: {
                ...
                plugins: {
                    title: { display: true, text: 'Progress Bulanan' },
                    legend: { position: 'top' },
                    tooltip: {
                        callbacks: {
    ...
    function updateBarChart(monthlyAccumulative) {
        ...
        barChart = new Chart(document.getElementById('barChart'), {
            ...
            options: {
                ...
                maintainAspectRatio: false,
                plugins: {
                    title: { display: true, text: 'Rencana vs Realisasi Bulanan' },
                    legend: { position: 'top' }
                },
                scales: {
                    y: {
