    ...
    if (in_array($_SESSION['hak_akses'], ['SuperAdmin', 'buib', 'Pimpinan', 'SekretarisPimpinan'])) {
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <i class="fas fa-chart-bar mr-2"></i>Realisasi per Deputy
                            </div>
                        </div>
                        <div class="card-body">
        ...
        <script>
            ...
            function updateTables(filteredData) {
                ...
                // Mapping antara status dengan class & icon
                    const statusMap = {
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="dokumen_rk_buib" autocomplete="off" value="${item.dokumen_rk_buib || ''}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
