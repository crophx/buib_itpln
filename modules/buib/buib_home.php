...
// jika file di include oleh file lain, tampilkan isi file
    ...
    if (in_array($_SESSION['hak_akses'], ['SuperAdmin', 'buib', 'Pimpinan', 'SekretarisPimpinan'])) {
        ...
        $main_query = mysqli_query($mysqli, "SELECT a.*, b.nama_deputy, c.nama_status
                                    ...
                                    INNER JOIN tbl_deputy_buib as b ON a.deputy_buib=b.id_deputy
                                    INNER JOIN tbl_status as c ON a.status_buib=c.id_status
        ...
        while ($data = mysqli_fetch_assoc($main_query)) {
            ...
            $kategori_nama = $data['nama_deputy'];
            ...
            <div class="page-inner py-45">
                <div class="d-flex align-items-left align-items-md-top flex-column flex-md-row">
                    <div class="page-header">
                        <!-- judul halaman -->
                        <h4 class="page-title"><i class="fas fa-folder-open mr-2"></i> buib</h4>
                        <!-- breadcrumbs -->
                        <ul class="breadcrumbs">
                            ...
                            <li class="separator"><i class="flaticon-right-arrow"></i></li>
                            <li class="nav-item"><a>Data BUIB</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control" id="filterProgram" onchange="updateCharts()">
                                        ...
                                        <?php
                                        // Query untuk mendapatkan daftar program unik dari tbl_rk_buib
                                        $program_query = mysqli_query($mysqli, "SELECT DISTINCT nama_program FROM tbl_rk_buib WHERE nama_program IS NOT NULL AND nama_program != '' ORDER BY nama_program")
                            ...
                            <tbody>
                                ...
                                foreach ($Realisasi_data as $data) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($data['nama_deputy']); ?></td>
                                            ...
                                            <div class="modal fade" id="modalUbahRealisasi<?php echo $data['id']; ?>" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="modules/buib/proses_ubah.php" method="POST"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="deputy_buib<?php echo $data['id']; ?>"
                                                                                class="form-label font-weight-semibold">
                                                                                <i class="fas fa-tags mr-1 text-success"></i>Deputy
                                                                                <span class="text-danger">*</span>
                                                                            </label>
                                                                            <select class="form-control"
                                                                                id="deputy_buib<?php echo $data['id']; ?>"
                                                                                name="deputy_buib" required>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="status_buib<?php echo $data['id']; ?>"
                                                                                class="form-label font-weight-semibold">
                                                                                <i
                                                                ...
                                                                <div class="alert alert-light border mt-3">
                                                                    ...
                                                                    <div class="row small">
                                                                        <div class="col-md-4">
                                                                            ...
                                                                            <span
                                                                                class="badge badge-primary"><?php echo htmlspecialchars($data['nama_deputy']); ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                            ...
                                            <div class="modal fade" id="modalHapusRealisasi<?php echo $data['id']; ?>" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body text-left">Anda yakin ingin menghapus data RK buib
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="modules/buib/proses_hapus.php?id=<?php echo $data['id']; ?>"
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="ml-md-auto py-2 py-md-0">
                <!-- button entri data -->
                        <a href="?module=form_entri_terkontrak_buib" class="btn btn-success btn-round">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body text-left">Anda yakin ingin menghapus data Kontrak
                                                            buib <strong><?php echo $data['nama_program']; ?></strong> Tanggal
                                                            <strong><?php echo date('d/m/Y', strtotime($data['tgl_surat'])); ?></strong>?
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-default btn-round"
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="ml-md-auto py-2 py-md-0">
                <!-- button entri data -->
                        <a href="?module=form_entri_ongoing_buib" class="btn btn-success btn-round">
            ...
            <div class="ml-md-auto py-2 py-md-0">
                <!-- button entri data -->
                        <a href="?module=form_entri_rk_buib" class="btn btn-success btn-round">
                            <span class="btn-label"><i class="fa fa-plus mr-2"></i></span> Entri Data Rencana Kegiatan
                        </a>
                    </div>
                </div>
