                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input name="dokumen_rk_buib" class="form-control" placeholder="Masukkan link dokumen on-going (opsional)" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">Keterangan tambahan mengenai program buib yang sedang berjalan</small>
                            </div>
                        </div>
                    </div>
