            ...
            <div class="d-flex align-items-left align-items-md-top flex-column flex-md-row">
                <div class="page-header">
                    ...
                    <ul class="breadcrumbs">
                        ...
                        <li class="nav-item"><a href="?module=lemtera">Lemtera</a></li>
                        <li class="separator"><i class="flaticon-right-arrow"></i></li>
    ...
    <div class="modal fade" id="modalEntri" tabindex="-1" role="dialog" aria-labelledby="modalEntriLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="modules/lemtera/proses_kategori.php" method="POST" id="formEntriKategori">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off"
                                        ...
                                        name="nama_entity_lemtera" 
                                        placeholder="Masukkan nama kategori entity"
                                        required>
                ...
                <div class="table-responsive">
                    ...
                    <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            $no = 1;
                            // sql statement untuk menampilkan data dari tabel "tbl_entity_lemtera"
                            $query = mysqli_query($mysqli, "SELECT * FROM tbl_entity_lemtera ORDER BY nama_entity_lemtera ASC")
                            ...
                            while ($data = mysqli_fetch_assoc($query)) { ?>
                                ...
                                <tr>
                                    ...
                                    <td width="250"><?php echo $data['nama_entity_lemtera']; ?></td>
                                    <td width="70" class="text-center">
                                        
                                        <!-- Button Edit Kategori -->
                                        <a href="#" class="btn btn-icon btn-round btn-success btn-sm" data-toggle="modal" data-target="#modalUbah<?php echo $data['id_entity']; ?>" data-tooltip="tooltip" title="Ubah">
                                            <i class="fas fa-pencil-alt fa-sm"></i>
                                        </a>

                                        <!-- Modal Edit Kategori -->
                                        <div class="modal fade" id="modalUbah<?php echo $data['id_entity']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalUbahLabel<?php echo $data['id_entity']; ?>" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    <!-- Modal Header -->
                                                    <div class="modal-header bg-warning text-white">
                                                        <h5 class="modal-title font-weight-bold" id="modalUbahLabel<?php echo $data['id_entity']; ?>">
                                                    ...
                                                    <form action="modules/lemtera/proses_kategori.php" method="POST" id="formKategori<?php echo $data['id_entity']; ?>">
                                                        <div class="modal-body">
                                                            <input type="hidden" name="id_entity" value="<?php echo $data['id_entity']; ?>">

                                                            <!-- Form Edit Nama Kategori -->
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        <label for="nama_entity_lemtera<?php echo $data['id_entity']; ?>" class="form-label font-weight-semibold">
                                                                            <i class="fas fa-graduation-cap mr-1 text-primary"></i>Nama Kategori <span class="text-danger">*</span>
                                                                        </label>
                                                                        <input type="text" autocomplete="off"
                                                                            class="form-control" 
                                                                            id="nama_entity_lemtera<?php echo $data['id_entity']; ?>" 
                                                                            name="nama_entity_lemtera" 
                                                                            value="<?php echo htmlspecialchars($data['nama_entity_lemtera']); ?>" 
                                                                            placeholder="Masukkan nama entity lemtera"
                                                                            required>
                                                                        <small class="form-text text-muted">
                                        ...
                                        <!-- button hapus data -->
                                        <a href="#" class="btn btn-icon btn-round btn-danger btn-sm" data-toggle="modal" data-target="#modalHapus<?php echo $data['id_entity']; ?>" data-tooltip="tooltip" data-placement="top" title="Hapus">
                                            <i class="fas fa-trash fa-sm"></i>
                                        </a>

                                        <!-- Modal Hapus -->
                                        <div class="modal fade" id="modalHapus<?php echo $data['id_entity']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalHapusLabel<?php echo $data['id_entity']; ?>" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-danger text-white">
                                                        <h5 class="modal-title font-weight-bold" id="modalHapusLabel<?php echo $data['id_entity']; ?>">
                                                    ...
                                                    <div class="modal-body text-center">
                                                        ...
                                                        <div class="alert alert-light border">
                                                            <strong class="text-danger"><?php echo htmlspecialchars($data['nama_entity_lemtera']); ?></strong>
                                                        </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="modules/lemtera/proses_kategori.php" method="POST">
                                                        <input type="hidden" name="id_entity" value="<?php echo $data['id_entity']; ?>">
