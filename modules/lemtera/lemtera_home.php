...
// jika file di include oleh file lain, tampilkan isi file
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">
                            <i class="fas fa-chart-bar mr-2"></i>Target vs Realisasi per Deputy lemtera
                        </div>
                    </div>
                    <div class="card-body">
                    ...
                    <table id="realizedDataTable" class="display table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Deputy lemtera</th>
                            ...
                            foreach ($realized_data as $data) {
                                ...
                                <tr>
                                    ...
                                    <td width="80" class="text-center">
                                        <a href="?module=form_ubah_rk_lemtera&id=<?php echo $data['id']; ?>" class="btn btn-icon btn-round btn-success btn-sm mr-1" data-tooltip="tooltip" title="Ubah">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="modules/rk_lemtera/proses_hapus.php?id=<?php echo $data['id']; ?>" class="btn btn-danger btn-round">Ya, Hapus</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if ($.fn.DataTable.isDataTable('#rklemteraDataTable')) {
                $('#rklemteraDataTable').DataTable().destroy();
            }
            
            $('#rklemteraDataTable').DataTable({
                "pageLength": 25,
                "order": [[ 5, "desc" ]],
                "columnDefs": [
