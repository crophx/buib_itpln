...
// jika file di include oleh file lain, tampilkan isi file
    ...
    if (in_array($_SESSION['hak_akses'], ['SuperAdmin', 'LEMTERA', 'Pimpinan', 'SekretarisPimpinan'])) {
        ...
        while ($data = mysqli_fetch_assoc($main_query)) {
            ...
            $kategori_nama = $data['nama_entity_lemtera'];
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control" id="filterTahun" onchange="updateCharts()">
                                        ...
                                        $tahun_query = mysqli_query($mysqli, "SELECT DISTINCT YEAR(tgl_surat) as tahun FROM tbl_rk_lemtera ORDER BY tahun DESC")
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control" id="filterProgram" onchange="updateCharts()">
                                        ...
                                        <?php
                                        // Query untuk mendapatkan daftar program unik dari tbl_rk_lemtera
                                        $program_query = mysqli_query($mysqli, "SELECT DISTINCT nama_program FROM tbl_rk_lemtera WHERE nama_program IS NOT NULL AND nama_program != '' ORDER BY nama_program")
                                ...
                                <div class="col">
                                    <div class="numbers">
                                        ...
                                        <h4 class="card-title mb-0">Rp
                                            <?php echo number_format($total_target_calc, 0, ',', '.'); ?>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    <div class="numbers">
                                        ...
                                        <h4 class="card-title mb-0">Rp
                                            <?php echo number_format($total_realisasi_calc, 0, ',', '.'); ?>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    <div class="numbers">
                                        ...
                                        <h4 class="card-title mb-0"><?php echo number_format($total_doc_calc, 0, ',', '.'); ?>
                                        </h4>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="ml-md-auto py-2 py-md-0">
                <!-- button entri data -->
                        <a href="?module=form_entri_realisasi_lemtera" class="btn btn-success btn-round">
                                ...
                                foreach ($Realisasi_data as $data) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">Rp
                                            <?php echo number_format($data['realisasi_nominal'], 0, ',', '.'); ?>
                                        </td>
                                        <td width="100" class="text-center">
                                            <?php echo date('M-Y', strtotime($data['tgl_surat'])); ?>
                                        </td>
                                        <td width="80" class="text-center">
                                            <!-- Button Edit Realisasi -->
                                            <a href="#" class="btn btn-icon btn-round btn-success btn-sm" data-toggle="modal"
                                                data-target="#modalUbahRealisasi<?php echo $data['id']; ?>" data-tooltip="tooltip"
                                                title="Ubah">
                                                <i class="fas fa-pencil-alt fa-sm"></i>
                                            </a>
                                            <!-- Form Modal Edit Realisasi -->
                                            <div class="modal fade" id="modalUbahRealisasi<?php echo $data['id']; ?>" tabindex="-1"
                                                role="dialog" aria-labelledby="modalRealisasiLabel<?php echo $data['id']; ?>"
                                                aria-hidden="true">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-header btn-success text-white">
                                                            <h5 class="modal-title font-weight-bold"
                                                                id="modalRealisasiLabel<?php echo $data['id']; ?>">
                                                        ...
                                                        <form action="modules/lemtera/proses_ubah.php" method="POST"
                                                            id="formUbahRealisasi<?php echo $data['id']; ?>">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="nama_program<?php echo $data['id']; ?>"
                                                                                class="form-label font-weight-semibold">
                                                                                <i
                                                                                    class="fas fa-graduation-cap mr-1 text-primary"></i>Nama
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="entity_lemtera<?php echo $data['id']; ?>"
                                                                                class="form-label font-weight-semibold">
                                                                                <i class="fas fa-tags mr-1 text-success"></i>Entity
                                                                                <span class="text-danger">*</span>
                                                                            </label>
                                                                            <select class="form-control"
                                                                                id="entity_lemtera<?php echo $data['id']; ?>"
                                                                                name="entity_lemtera" required>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="realisasi_nominal<?php echo $data['id']; ?>"
                                                                                class="form-label font-weight-semibold">
                                                                                <i
                                                                                    class="fas fa-money-bill-wave mr-1 text-warning"></i>Nominal
                                                                                Realisasi <span class="text-danger">*</span>
                                                                            </label>
                                                                            <div class="input-group">
                                                                                <div class="input-group-prepend">
                                                                                    <span
                                                                                        class="input-group-text bg-warning text-white">Rp</span>
                                                                                </div>
                                                                                <input type="text" autocomplete="off"
                                                                            ...
                                                                            <small class="form-text text-muted">
                                                                                <i class="fas fa-info-circle mr-1"></i>Ubah nominal
                                                                                realisasi
                                                                            </small>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="tgl_surat<?php echo $data['id']; ?>"
                                                                                class="form-label font-weight-semibold">
                                                                                <i
                                                                                    class="fas fa-calendar-alt mr-1 text-info"></i>Tanggal
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="status_lemtera<?php echo $data['id']; ?>"
                                                                                class="form-label font-weight-semibold">
                                                                                <i
                                                                                    class="fas fa-info-circle mr-1 text-success"></i>Status
                                                                                <span class="text-danger">*</span>
                                                                            </label>
                                                                            <select class="form-control"
                                                                                id="status_lemtera<?php echo $data['id']; ?>"
                                                                                name="status_lemtera" required>
                                                                                ...
                                                                                while ($status = mysqli_fetch_array($status_query)) {
                                                                                    $selected = ($status['id_status'] == $data['status_lemtera']) ? 'selected' : '';
                                                                                    echo "<option value='" . $status['id_status'] . "' " . $selected . ">" . $status['nama_status'] . "</option>";
                                                                                }
                                                                                ?>
                                                                            </select>
                                                                            <small class="form-text text-muted">
                                                                                <i class="fas fa-check-circle mr-1"></i>Update jika
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label
                                                                                for="keterangan_program<?php echo $data['id']; ?>"
                                                                                class="form-label font-weight-semibold">
                                                                                <i
                                                                                    class="fas fa-sticky-note mr-1 text-secondary"></i>Keterangan
                                                                            </label>
                                                                            <textarea class="form-control"
                                                                                id="keterangan_program<?php echo $data['id']; ?>"
                                                                                name="keterangan_program" rows="3"
                                                                ...
                                                                <div class="alert alert-light border mt-3">
                                                                    ...
                                                                    <div class="row small">
                                                                        <div class="col-md-4">
                                                                            ...
                                                                            <span
                                                                                class="badge badge-primary"><?php echo htmlspecialchars($data['nama_entity_lemtera']); ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <strong>Status:</strong><br>
                                                                            <span
                                                                                class="badge badge-success"><?php echo htmlspecialchars($data['nama_status']); ?></span><br><br>
                                                                            <strong>Nominal:</strong><br>
                                                                            <span class="text-warning font-weight-bold">Rp
                                                                                <?php echo number_format($data['realisasi_nominal'], 0, ',', '.'); ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            ...
                                                                            <span
                                                                                class="badge badge-info"><?php echo date('M-Y', strtotime($data['tgl_surat'])); ?></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <a href="#" class="btn btn-icon btn-round btn-danger btn-sm" data-toggle="modal"
                                                data-target="#modalHapusRealisasi<?php echo $data['id']; ?>" data-tooltip="tooltip"
                                                title="Hapus">
                                                <i class="fas fa-trash fa-sm"></i>
                                            </a>

                                            <!-- Modal Hapus -->
                                            <div class="modal fade" id="modalHapusRealisasi<?php echo $data['id']; ?>" tabindex="-1"
                                                role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"><i class="fas fa-trash mr-2"></i>Hapus Data RK
                                                                lemtera</h5>
                                                        </div>
                                                        <div class="modal-body text-left">Anda yakin ingin menghapus data RK lemtera
                                                            <strong><?php echo $data['nama_program']; ?></strong> Tanggal
                                                            <strong><?php echo date('d/m/Y', strtotime($data['tgl_surat'])); ?></strong>?
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-default btn-round"
                                                                data-dismiss="modal">Batal</button>
                                                            <a href="modules/lemtera/proses_hapus.php?id=<?php echo $data['id']; ?>"
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="ml-md-auto py-2 py-md-0">
                <!-- button entri data -->
                        <a href="?module=form_entri_terkontrak_lemtera" class="btn btn-success btn-round">
                            ...
                            <tbody>
                                ...
                                foreach ($kontrak_data as $data) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">Rp
                                            <?php echo number_format($data['kontrak_nominal'], 0, ',', '.'); ?>
                                        </td>
                                        <td width="80" class="text-center">
                                            <span
                                                class="badge badge-primary"><?php echo htmlspecialchars($data['nama_status']); ?></span><br>
                                        </td>
                                        <td width="80" class="text-center">
                                            <a href="#" class="btn btn-icon btn-round btn-success btn-sm mr-1" data-toggle="modal"
                                                data-target="#modalUbahKontrak<?php echo $data['id']; ?>" data-tooltip="tooltip"
                                                title="Ubah">
                                                <i class="fas fa-pencil-alt fa-sm"></i>
                                            </a>
                                            <!-- Modal Edit Kontrak -->
                                            <div class="modal fade" id="modalUbahKontrak<?php echo $data['id']; ?>" tabindex="-1"
                                                role="dialog" aria-labelledby="modalUbahKontrakLabel<?php echo $data['id']; ?>"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <!-- Modal Header -->
                                                        <div class="modal-header btn-success text-white">
                                                            <h5 class="modal-title font-weight-bold"
                                                                id="modalUbahKontrakLabel<?php echo $data['id']; ?>">
                                                        ...
                                                        <form action="modules/lemtera/proses_ubah.php" method="POST"
                                                            id="formUbahKontrak<?php echo $data['id']; ?>">
                                                            <div class="modal-body">
                                                                <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="kontrak_nominal<?php echo $data['id']; ?>"
                                                                                class="form-label font-weight-semibold">
                                                                                <i
                                                                                    class="fas fa-money-bill-wave mr-1 text-warning"></i>Nominal
                                                                            ...
                                                                            <small class="form-text text-muted">
                                                                                <i class="fas fa-info-circle mr-1"></i>Jika sudah
                                                                                terealisasi, isi dengan 0
                                                                            </small>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="realisasi_nominal<?php echo $data['id']; ?>"
                                                                                class="form-label font-weight-semibold">
                                                                                <i
                                                                                    class="fas fa-bullseye mr-1 text-primary"></i>Realisasi
                                                                                Nominal
                                                                            </label>
                                                                            <div class="input-group">
                                                                                <div class="input-group-prepend">
                                                                                    <span
                                                                                        class="input-group-text bg-primary text-white">Rp</span>
                                                                                </div>
                                                                            ...
                                                                            <small class="form-text text-muted">
                                                                                <i class="fas fa-lightbulb mr-1"></i>Nominal yang
                                                                                sudah diterima
                                                                            </small>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="alert alert-light border mt-3">
                                                                    ...
                                                                    <div class="row small">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            ...
                                                                            <strong>Nominal:</strong><br>
                                                                            <span class="text-warning font-weight-bold">Rp
                                                                                <?php echo number_format($data['kontrak_nominal'], 0, ',', '.'); ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <strong>Tanggal:</strong><br>
                                                                            <?php echo date('d/m/Y', strtotime($data['tgl_surat'])); ?><br><br>
                                            ...
                                            <!-- Modal Hapus Kontrak-->
                                            <a href="#" class="btn btn-icon btn-round btn-danger btn-sm" data-toggle="modal"
                                                data-target="#modalHapusKontrak<?php echo $data['id']; ?>" data-tooltip="tooltip"
                                                title="Hapus">
                                                <i class="fas fa-trash fa-sm"></i>
                                            </a>
                                            <!-- Modal Hapus Kontrak-->
                                            <div class="modal fade" id="modalHapusKontrak<?php echo $data['id']; ?>" tabindex="-1"
                                                role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"><i class="fas fa-trash mr-2"></i>Hapus Data
                                                                Kontrak lemtera</h5>
                                                        </div>
                                                        <div class="modal-body text-left">Anda yakin ingin menghapus data Kontrak
                                                            lemtera <strong><?php echo $data['nama_program']; ?></strong> Tanggal
                                                            <strong><?php echo date('d/m/Y', strtotime($data['tgl_surat'])); ?></strong>?
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-default btn-round"
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="ml-md-auto py-2 py-md-0">
                <!-- button entri data -->
                        <a href="?module=form_entri_ongoing_lemtera" class="btn btn-success btn-round">
                            ...
                            <tbody>
                                ...
                                foreach ($ongoing_data as $data) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">Rp
                                            <?php echo number_format($data['ongoing_nominal'], 0, ',', '.'); ?>
                                        </td>
                                        <td width="80" class="text-center">
                                            <span
                                                class="badge badge-danger"><?php echo htmlspecialchars($data['nama_status']); ?></span><br>
                                        </td>
                                        <td width="100" class="text-center">
                                            <!-- Button Edit Ongoing -->
                                            <a href="#" class="btn btn-icon btn-round btn-success btn-sm" data-toggle="modal"
                                                data-target="#modalUbahOngoing<?php echo $data['id']; ?>" data-tooltip="tooltip"
                                                title="Ubah">
                                                <i class="fas fa-pencil-alt fa-sm"></i>
                                            </a>
                                            <!-- Form Modal Edit Ongoing -->
                                            <div class="modal fade" id="modalUbahOngoing<?php echo $data['id']; ?>" tabindex="-1"
                                                role="dialog" aria-labelledby="modalUbahOngoingLabel<?php echo $data['id']; ?>"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <!-- Modal Header -->
                                                        <div class="modal-header btn-success text-white">
                                                            <h5 class="modal-title font-weight-bold"
                                                                id="modalUbahOngoingLabel<?php echo $data['id']; ?>">
                                                        ...
                                                        <form action="modules/lemtera/proses_ubah.php" method="POST"
                                                            id="formUbahOngoing<?php echo $data['id']; ?>">
                                                            <div class="modal-body">
                                                                <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="ongoing_nominal<?php echo $data['id']; ?>"
                                                                                class="form-label font-weight-semibold">
                                                                                <i
                                                                                    class="fas fa-money-bill-wave mr-1 text-warning"></i>Nominal
                                                                                Ongoing <span class="text-danger">*</span>
                                                                            </label>
                                                                            <div class="input-group">
                                                                                <div class="input-group-prepend">
                                                                                    <span
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="kontrak_nominal<?php echo $data['id']; ?>"
                                                                                class="form-label font-weight-semibold">
                                                                                <i
                                                                                    class="fas fa-bullseye mr-1 text-primary"></i>Kontrak
                                                                                Nominal
                                                                            </label>
                                                                            <div class="input-group">
                                                                                <div class="input-group-prepend">
                                                                            ...
                                                                            <small class="form-text text-muted">
                                                                                <i class="fas fa-lightbulb mr-1"></i>Kontrak yang
                                                                                sudah disepakati
                                                                            </small>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="alert alert-light border mt-3">
                                                                    ...
                                                                    <div class="row small">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            ...
                                                                            <strong>Nominal:</strong><br>
                                                                            <span class="text-warning font-weight-bold">Rp
                                                                                <?php echo number_format($data['ongoing_nominal'], 0, ',', '.'); ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <strong>Tanggal:</strong><br>
                                                                            <?php echo date('d/m/Y', strtotime($data['tgl_surat'])); ?><br><br>
                                            ...
                                            <!-- Modal Hapus ONgoing -->
                                            <a href="#" class="btn btn-icon btn-round btn-danger btn-sm" data-toggle="modal"
                                                data-target="#modalHapusOngoing<?php echo $data['id']; ?>" data-tooltip="tooltip"
                                                title="Hapus">
                                                <i class="fas fa-trash fa-sm"></i>
                                            </a>
                                            <div class="modal fade" id="modalHapusOngoing<?php echo $data['id']; ?>" tabindex="-1"
                                                role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body text-left">Anda yakin ingin menghapus data OnGoing
                                                            lemtera <strong><?php echo $data['nama_program']; ?></strong> Tanggal
                                                            <strong><?php echo date('d/m/Y', strtotime($data['tgl_surat'])); ?></strong>?
                                                        </div>
                                                        <div class="modal-footer">
                            ...
                            <tbody>
                                ...
                                foreach ($target_data as $data) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge badge-<?php echo $deputy_class; ?>"><?php echo htmlspecialchars($data['nama_program']); ?></span>
                                        </td>
                                        <td><?php echo htmlspecialchars($data['keterangan_program']); ?></td>
                                        <td class="text-right">Rp <?php echo number_format($data['target_nominal'], 0, ',', '.'); ?>
                                        </td>
                                        <td width="120" class="text-center">
                                            <span
                                                class="badge badge-warning"><?php echo htmlspecialchars($data['nama_status']); ?></span><br>
                                        </td>
                                        <td width="80" class="text-center">
                                            <!-- Button Edit Rencana -->
                                            <a href="#" class="btn btn-icon btn-round btn-success btn-sm" data-toggle="modal"
                                                data-target="#modalUbahRencana<?php echo $data['id']; ?>" data-tooltip="tooltip"
                                                title="Ubah">
                                                <i class="fas fa-pencil-alt fa-sm"></i>
                                            </a>
                                            <!-- Form Modal Edit Rencana -->
                                            <div class="modal fade" id="modalUbahRencana<?php echo $data['id']; ?>" tabindex="-1"
                                                role="dialog" aria-labelledby="modalRencanaLabel<?php echo $data['id']; ?>"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <!-- Modal Header -->
                                                        <div class="modal-header btn-success text-white">
                                                            <h5 class="modal-title font-weight-bold"
                                                                id="modalRencanaLabel<?php echo $data['id']; ?>">
                                                        ...
                                                        <form action="modules/lemtera/proses_ubah.php" method="POST"
                                                            id="formUbahRencana<?php echo $data['id']; ?>">
                                                            <div class="modal-body">
                                                                <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="target_nominal<?php echo $data['id']; ?>"
                                                                                class="form-label font-weight-semibold">
                                                                                <i
                                                                                    class="fas fa-money-bill-wave mr-1 text-warning"></i>Nominal
                                                                                Rencana <span class="text-danger">*</span>
                                                                            </label>
                                                                            <div class="input-group">
                                                                                <div class="input-group-prepend">
                                                                                    <span
                                                                ...
                                                                <div class="alert alert-light border mt-3">
                                                                    ...
                                                                    <div class="row small">
                                                                        <div class="col-md-4">
                                                                            ...
                                                                            <strong>Status:</strong><br>
                                                                            <span
                                                                                class="badge badge-success"><?php echo htmlspecialchars($data['nama_status']); ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">

                                                                            <strong>Nominal:</strong><br>
                                                                            <span class="text-warning font-weight-bold">Rp
                                                                                <?php echo number_format($data['target_nominal'], 0, ',', '.'); ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <strong>Tanggal:</strong><br>
                                                                            <?php echo date('d/m/Y', strtotime($data['tgl_surat'])); ?><br><br>
                                            ...
                                            <a href="#" class="btn btn-icon btn-round btn-danger btn-sm" data-toggle="modal"
                                                data-target="#modalHapusTarget<?php echo $data['id']; ?>" data-tooltip="tooltip"
                                                title="Hapus">
                                                <i class="fas fa-trash fa-sm"></i>
                                            </a>
                                            <!-- Modal Hapus -->
                                            <div class="modal fade" id="modalHapusTarget<?php echo $data['id']; ?>" tabindex="-1"
                                                role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body text-left">Anda yakin ingin menghapus data Rencana
                                                            Lemtera<strong><?php echo $data['nama_program']; ?></strong> Tanggal
                                                            <strong><?php echo date('d/m/Y', strtotime($data['tgl_surat'])); ?></strong>?
                                                        </div>
                                                        <div class="modal-footer">
                    ...
                    kategoriChart = new Chart(ctx, {
                        ...
                        options: {
                            ...
                            plugins: {
                                title: {
                                    display: true,
                                    text: 'Distribusi Kategori Lemtera'
                                },
                                legend: {
                                    position: 'bottom',
                                    labels: {
                ...
                $(document).ready(function () {
                    ...
                    if (pesan === '1') {
                        ...
                        setTimeout(function () {
                            ...
                            window.history.replaceState({}, document.title, window.location.pathname + '?module=lemtera');
                            location.reload();
                        }, 2000);
                    }
                    // jika pesan = 2
