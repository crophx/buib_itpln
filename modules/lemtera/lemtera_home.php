                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="entity_lemtera" required>
                                                ...
                                                while ($kategori = mysqli_fetch_array($kategori_query)) {
                                                    echo "<option value='{$kategori['id_entity']}' " . ($kategori['id_entity'] == '${item.entity_lemtera}' ? 'selected' : '') . ">{$kategori['nama_entity_lemtera']}</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="status_lemtera" required>
                                                ...
                                                while ($status = mysqli_fetch_array($status_query)) {
                                                    echo "<option value='{$status['id_status']}' " . ($status['id_status'] == '${item.status_lemtera}' ? 'selected' : '') . ">{$status['nama_status']}</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
