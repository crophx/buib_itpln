                                        ...
                                        <div class="modal fade" id="modalUbahRealisasi<?php echo $data['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalRealisasiLabel<?php echo $data['id']; ?>" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="modules/lemtera/proses_ubah.php" method="POST" id="formUbahRealisasi<?php echo $data['id']; ?>">
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="status_lemtera<?php echo $data['id']; ?>" class="form-label font-weight-semibold">
                                                            ...
                                                            <div class="alert alert-light border mt-3">
                                                                ...
                                                                <div class="row small">
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <span class="badge badge-primary"><?php echo htmlspecialchars($data['nama_entity_lemtera']); ?></span>
                                                                    </div>
                                                                    <div class="col-md-4">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"><i class="fas fa-trash mr-2"></i>Hapus Data RK lemtera</h5>
                                                    </div>
                                                    <div class="modal-body text-left">Anda yakin ingin menghapus data RK lemtera <strong><?php echo $data['nama_program']; ?></strong> Tanggal <strong><?php echo date('d/m/Y', strtotime($data['tgl_surat'])); ?></strong>?</div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-default btn-round" data-dismiss="modal">Batal</button>
                                                        <a href="modules/lemtera/proses_hapus.php?id=<?php echo $data['id']; ?>" class="btn btn-danger btn-round">Ya, Hapus</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <td width="80" class="text-center">
                                        ...
                                        <div class="modal fade" id="modalUbahKontrak<?php echo $data['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalUbahKontrakLabel<?php echo $data['id']; ?>" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="modules/lemtera/proses_ubah.php" method="POST" id="formUbahKontrak<?php echo $data['id']; ?>">
                                                        <div class="modal-body">
                                                            <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
                                        ...
                                        <div class="modal fade" id="modalHapusKontrak<?php echo $data['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"><i class="fas fa-trash mr-2"></i>Hapus Data Kontrak lemtera</h5>
                                                    </div>
                                                    <div class="modal-body text-left">Anda yakin ingin menghapus data Kontrak lemtera <strong><?php echo $data['nama_program']; ?></strong> Tanggal <strong><?php echo date('d/m/Y', strtotime($data['tgl_surat'])); ?></strong>?</div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-default btn-round" data-dismiss="modal">Batal</button>
                                                        <a href="modules/lemtera/proses_hapus.php?id=<?php echo $data['id']; ?>" class="btn btn-danger btn-round">Ya, Hapus</a>
                                                    </div>
                                    ...
                                    <td width="100" class="text-center">
                                        ...
                                        <div class="modal fade" id="modalUbahOngoing<?php echo $data['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalUbahOngoingLabel<?php echo $data['id']; ?>" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="modules/lemtera/proses_ubah.php" method="POST" id="formUbahOngoing<?php echo $data['id']; ?>">
                                                        <div class="modal-body">
                                                            <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
                                        ...
                                        <div class="modal fade" id="modalHapusOngoing<?php echo $data['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"><i class="fas fa-trash mr-2"></i>Hapus Data OnGoing lemtera</h5>
                                                    </div>
                                                    <div class="modal-body text-left">Anda yakin ingin menghapus data OnGoing lemtera <strong><?php echo $data['nama_program']; ?></strong> Tanggal <strong><?php echo date('d/m/Y', strtotime($data['tgl_surat'])); ?></strong>?</div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-default btn-round" data-dismiss="modal">Batal</button>
                                                        <a href="modules/lemtera/proses_hapus.php?id=<?php echo $data['id']; ?>" class="btn btn-danger btn-round">Ya, Hapus</a>
                                                    </div>
                                    ...
                                    <td width="80" class="text-center">
                                        ...
                                        <div class="modal fade" id="modalUbahRencana<?php echo $data['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalRencanaLabel<?php echo $data['id']; ?>" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="modules/lemtera/proses_ubah.php" method="POST" id="formUbahRencana<?php echo $data['id']; ?>">
                                                        <div class="modal-body">
                                                            <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
                                        ...
                                        <div class="modal fade" id="modalHapusTarget<?php echo $data['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"><i class="fas fa-trash mr-2"></i>Hapus Data Rencana Lemtera</h5>
                                                    </div>
                                                    <div class="modal-body text-left">Anda yakin ingin menghapus data Rencana Lemtera<strong><?php echo $data['nama_program']; ?></strong> Tanggal <strong><?php echo date('d/m/Y', strtotime($data['tgl_surat'])); ?></strong>?</div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-default btn-round" data-dismiss="modal">Batal</button>
                                                        <a href="modules/lemtera/proses_hapus.php?id=<?php echo $data['id']; ?>" class="btn btn-danger btn-round">Ya, Hapus</a>
                                                    </div>
