                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-stats ml-3 ml-sm-0">
                            <div class="numbers">
                                ...
                                <h4 class="card-title"><?php echo number_format($stats['total_disetujui']); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-stats ml-3 ml-sm-0">
                            <div class="numbers">
                                ...
                                <h4 class="card-title"><?php echo number_format($stats['total_menunggu']); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-stats ml-3 ml-sm-0">
                            <div class="numbers">
                                ...
                                <h4 class="card-title"><?php echo number_format($stats['total_ditolak']); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-stats card-round">
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col col-stats ml-3 ml-sm-0">
                            <div class="numbers">
                                <p class="card-category">Disetujui Minggu Ini</p>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title"><i class="fas fa-filter mr-2"></i>Filter & Pencarian</div>
                </div>
                <div class="card-body">
                    <form method="GET" action="">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group"><label>Pencarian</label><input type="text" class="form-control"
                                        name="search" placeholder="Cari judul, perihal, nomor..."
                            ...
                            <div class="col-md-3">
                                <div class="form-group"><label>Jenis Dokumen</label><select class="form-control"
                                        ...
                                        <?php mysqli_data_seek($query_jenis, 0);
                                        while ($jenis = mysqli_fetch_assoc($query_jenis)): ?>
                                            <option value="<?php echo $jenis['id_jenis']; ?>" <?php echo $jenis_filter == $jenis['id_jenis'] ? 'selected' : ''; ?>>
                                                <?php echo $jenis['nama_jenis']; ?>
                                            </option><?php endwhile; ?>
                                    </select></div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group"><label>Bulan</label><select class="form-control" name="bulan">
                                        <option value="">Semua Bulan</option>
                                        <?php mysqli_data_seek($query_bulan, 0);
                                        while ($bulan = mysqli_fetch_assoc($query_bulan)): ?>
                                            <option value="<?php echo $bulan['bulan']; ?>" <?php echo $bulan_filter == $bulan['bulan'] ? 'selected' : ''; ?>>
                            ...
                            <div class="col-md-2">
                                <div class="form-group"><label>Tahun</label><select class="form-control" name="tahun">
                                        <option value="">Semua Tahun</option>
                                        <?php mysqli_data_seek($query_tahun, 0);
                                        while ($tahun = mysqli_fetch_assoc($query_tahun)): ?>
                                            <option value="<?php echo $tahun['tahun']; ?>" <?php echo $tahun_filter == $tahun['tahun'] ? 'selected' : ''; ?>>
                            ...
                            <div class="col-md-1">
                                <div class="form-group"><label> </label>
                                    <div class="btn-group-vertical d-block"><button type="submit"
                                            class="btn btn-primary btn-sm"><i class="fas fa-search"></i></button><a
                                            href="?module=riwayat_pengajuan" class="btn btn-secondary btn-sm mt-1"><i
                                                class="fas fa-undo"></i></a></div>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h5 class="card-title mb-0"><i class="fas fa-list mr-2"></i>Daftar Riwayat -
                            <?php echo getStatusBadge('Disetujui'); ?>
                            (<?php echo number_format($total_data_disetujui); ?> pengajuan)
                        </h5>
                        <div class="ml-auto"><small class="text-muted">Menampilkan
                                <?php echo $total_data_disetujui > 0 ? $offset_disetujui + 1 : 0; ?> -
                                <?php echo min($offset_disetujui + $limit, $total_data_disetujui); ?> dari
                                <?php echo $total_data_disetujui; ?> data</small></div>
                    </div>
                </div>
                <div class="card-body">
                    <?php if (mysqli_num_rows($result_disetujui) > 0): ?>
                            ...
                            <table class="table table-hover">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <?php if (in_array($_SESSION['hak_akses'], ['SuperAdmin', 'Pimpinan', 'SekretarisPimpinan'])): ?>
                                            <th width="12%">Pengaju</th><?php endif; ?>
                                        <th width="12%">Catatan</th>
                                        <th width="12%">File</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php $no = $offset_disetujui + 1;
                                    while ($row = mysqli_fetch_assoc($result_disetujui)): ?>
                                        <tr>
                                            <td><?php echo $no++; ?></td>
                                            <td>
                                                <div class="text-sm">
                                                    <?php if ($row['tanggal_ttd']): ?><strong><?php echo date('d/m/Y', strtotime($row['tanggal_ttd'])); ?></strong><br><small
                                                            class="text-muted"><?php echo date('H:i', strtotime($row['tanggal_ttd'])); ?></small><?php else: ?><span
                                            ...
                                            <td>
                                                <div class="text-sm">
                                                    <strong><?php echo htmlspecialchars($row['judul_surat']); ?></strong><?php if (!empty($row['nomor_surat'])): ?><br><small
                                                            class="text-muted">No:
                                                            <?php echo htmlspecialchars($row['nomor_surat']); ?></small><?php endif; ?>
                                                </div>
                                            </td>
                                            <?php if (in_array($_SESSION['hak_akses'], ['SuperAdmin', 'Pimpinan', 'SekretarisPimpinan'])): ?>
                                                <td>
                                            ...
                                            <td><?php if (!empty($row['file_dokumen']) && file_exists($row['file_dokumen_signed'])): ?><a
                                                        href="<?php echo $row['file_dokumen_signed']; ?>"
                                                        class="btn btn-sm btn-outline-secondary" title="Lihat Dokumen Asli"
                                                        target="_blank"><i class="fas fa-eye"></i></a><?php else: ?><span
                        ...
                        <?php if ($total_pages_disetujui > 1): ?>
                            <div class="d-flex justify-content-between align-items-center mt-3">
                                <div><small class="text-muted">Halaman <?php echo $page_disetujui; ?> dari
                                        <?php echo $total_pages_disetujui; ?></small></div>
                                <nav>
                                    <ul class="pagination pagination-sm mb-0">
                                        <?php if ($page_disetujui > 1): ?>
                                            <li class="page-item"><a class="page-link"
                                                    href="<?php echo buildUrl(['page_disetujui' => $page_disetujui - 1]); ?>"><i
                                                        class="fas fa-chevron-left"></i></a></li><?php endif; ?>
                                        <?php for ($i = max(1, $page_disetujui - 2); $i <= min($total_pages_disetujui, $page_disetujui + 2); $i++): ?>
                                            <li class="page-item <?php echo $i == $page_disetujui ? 'active' : ''; ?>"><a
                                                    class="page-link"
                                                    href="<?php echo buildUrl(['page_disetujui' => $i]); ?>"><?php echo $i; ?></a>
                                            </li><?php endfor; ?>
                                        <?php if ($page_disetujui < $total_pages_disetujui): ?>
                                            <li class="page-item"><a class="page-link"
                                                    href="<?php echo buildUrl(['page_disetujui' => $page_disetujui + 1]); ?>"><i
                                                        class="fas fa-chevron-right"></i></a></li><?php endif; ?>
                                    </ul>
                                </nav>
                            </div>
                        <?php endif; ?>
                    <?php else: ?>
                        <div class="text-center py-3"><i class="fas fa-inbox fa-3x text-muted mb-3"></i>
                            <h5 class="text-muted">Tidak ada riwayat pengajuan</h5>
                            <p class="text-muted">Belum ada pengajuan dengan status Disetujui.</p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h5 class="card-title mb-0"><i class="fas fa-list mr-2"></i>Daftar Riwayat -
                            <?php echo getStatusBadge('Menunggu'); ?>
                            (<?php echo number_format($total_data_menunggu); ?> pengajuan)
                        </h5>
                        <div class="ml-auto"><small class="text-muted">Menampilkan
                                <?php echo $total_data_menunggu > 0 ? $offset_menunggu + 1 : 0; ?> -
                                <?php echo min($offset_menunggu + $limit, $total_data_menunggu); ?> dari
                                <?php echo $total_data_menunggu; ?> data</small></div>
                    </div>
                </div>
                <div class="card-body">
                    <?php if (mysqli_num_rows($result_menunggu) > 0): ?>
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php $no = $offset_menunggu + 1;
                                    while ($row = mysqli_fetch_assoc($result_menunggu)): ?>
                                        <tr>
                                            <td><?php echo $no++; ?></td>
                                            <td>
                                                <div class="text-sm">
                                                    <?php if ($row['tanggal_pengajuan']): ?><strong><?php echo date('d/m/Y', strtotime($row['tanggal_pengajuan'])); ?></small><?php else: ?><span
                                                                class="text-muted">-</span><?php endif; ?>
                                                </div>
                                            </td>
                                            <td><?php echo getStatusBadge($row['status_pengajuan']); ?></td>
                                            ...
                                            <td><?php if (!empty($row['file_dokumen']) && file_exists($row['file_dokumen'])): ?><a
                                                        href="<?php echo $row['file_dokumen']; ?>"
                                                        class="btn btn-sm btn-outline-secondary" title="Lihat Dokumen Asli"
                                                        target="_blank"><i class="fas fa-eye"></i></a><?php else: ?><span
                                                        class="text-muted">-</span><?php endif; ?></td>
                                        </tr>
                        ...
                        <?php if ($total_pages_menunggu > 1): ?>
                            <div class="d-flex justify-content-between align-items-center mt-3">
                                <div><small class="text-muted">Halaman <?php echo $page_menunggu; ?> dari
                                        <?php echo $total_pages_menunggu; ?></small></div>
                                <nav>
                                    <ul class="pagination pagination-sm mb-0">
                                        <?php if ($page_menunggu > 1): ?>
                                            <li class="page-item"><a class="page-link"
                                                    href="<?php echo buildUrl(['page_menunggu' => $page_menunggu - 1]); ?>"><i
                                                        class="fas fa-chevron-left"></i></a></li><?php endif; ?>
                                        <?php for ($i = max(1, $page_menunggu - 2); $i <= min($total_pages_menunggu, $page_menunggu + 2); $i++): ?>
                                            <li class="page-item <?php echo $i == $page_menunggu ? 'active' : ''; ?>"><a
                                                    class="page-link"
                                                    href="<?php echo buildUrl(['page_menunggu' => $i]); ?>"><?php echo $i; ?></a>
                                            </li><?php endfor; ?>
                                        <?php if ($page_menunggu < $total_pages_menunggu): ?>
                                            <li class="page-item"><a class="page-link"
                                                    href="<?php echo buildUrl(['page_menunggu' => $page_menunggu + 1]); ?>"><i
                                                        class="fas fa-chevron-right"></i></a></li><?php endif; ?>
                                    </ul>
                    ...
                    <?php else: ?>
                        <div class="text-center py-3"><i class="fas fa-inbox fa-3x text-muted mb-3"></i>
                            <h5 class="text-muted">Tidak ada riwayat pengajuan</h5>
                            <p class="text-muted">Belum ada pengajuan dengan status Menunggu.</p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h5 class="card-title mb-0"><i class="fas fa-list mr-2"></i>Daftar Riwayat -
                            <?php echo getStatusBadge('Ditolak'); ?> (<?php echo number_format($total_data_ditolak); ?>
                            pengajuan)
                        </h5>
                        <div class="ml-auto"><small class="text-muted">Menampilkan
                                <?php echo $total_data_ditolak > 0 ? $offset_ditolak + 1 : 0; ?> -
                                <?php echo min($offset_ditolak + $limit, $total_data_ditolak); ?> dari
                                <?php echo $total_data_ditolak; ?> data</small></div>
                    </div>
                </div>
                <div class="card-body">
                    <?php if (mysqli_num_rows($result_ditolak) > 0): ?>
                        ...
                        <?php if ($total_pages_ditolak > 1): ?>
                            <div class="d-flex justify-content-between align-items-center mt-3">
                                <div><small class="text-muted">Halaman <?php echo $page_ditolak; ?> dari
                                        <?php echo $total_pages_ditolak; ?></small></div>
                                <nav>
                                    <ul class="pagination pagination-sm mb-0">
                                        <?php if ($page_ditolak > 1): ?>
                                            <li class="page-item"><a class="page-link"
                                                    href="<?php echo buildUrl(['page_ditolak' => $page_ditolak - 1]); ?>"><i
                                                        class="fas fa-chevron-left"></i></a></li><?php endif; ?>
                                        <?php for ($i = max(1, $page_ditolak - 2); $i <= min($total_pages_ditolak, $page_ditolak + 2); $i++): ?>
                                            <li class="page-item <?php echo $i == $page_ditolak ? 'active' : ''; ?>"><a
                                                    class="page-link"
                                                    href="<?php echo buildUrl(['page_ditolak' => $i]); ?>"><?php echo $i; ?></a>
                                            </li><?php endfor; ?>
                                        <?php if ($page_ditolak < $total_pages_ditolak): ?>
                                            <li class="page-item"><a class="page-link"
                                                    href="<?php echo buildUrl(['page_ditolak' => $page_ditolak + 1]); ?>"><i
                                                        class="fas fa-chevron-right"></i></a></li><?php endif; ?>
                                    </ul>
                    ...
                    <?php else: ?>
                        <div class="text-center py-3"><i class="fas fa-inbox fa-3x text-muted mb-3"></i>
                            <h5 class="text-muted">Tidak ada riwayat pengajuan</h5>
                            <p class="text-muted">Belum ada pengajuan dengan status Ditolak.</p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
