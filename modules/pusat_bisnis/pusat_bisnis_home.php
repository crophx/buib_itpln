            ...
            <div class="page-inner py-45">
                <div class="d-flex align-items-left align-items-md-top flex-column flex-md-row">
                    <div class="page-header">
                        <!-- judul halaman -->
                        <h4 class="page-title"><i class="fas fa-folder-open mr-2"></i>Pusat Bisnis</h4>
                        <!-- breadcrumbs -->
                            ...
                            <tbody>
                                ...
                                foreach ($table_data as $data) {
                                    ...
                                    <tr>
                                        ...
                                        <td width="80" class="text-right">Rp
                                            <?php echo number_format($data['target_nominal'], 0, ',', '.'); ?>
                                        </td>
                                        <td width="80" class="text-right">Rp
                                        ...
                                        <td width="80" class="text-center">
                                            <span
                                                class="badge badge-<?php echo $status_class; ?>"><?php echo $persentase_item; ?>%</span>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <a href="?module=tampil_detail_bks&id=<?php echo $data['id_bks']; ?>"
                                        ...
                                        <td width="80" class="text-center">
                                            <div>
                                                <!-- button ubah data -->
                                                <a href="?module=form_ubah_bks&id=<?php echo $data['id_bks']; ?>"
                                                ...
                                                <a href="#" class="btn btn-icon btn-round btn-danger btn-sm" data-toggle="modal"
                                                    data-target="#modalHapus<?php echo $data['id_bks']; ?>" data-tooltip="tooltip"
                                                    data-placement="top" title="Hapus">
                                                    <i class="fas fa-trash fa-sm"></i>
                                                </a>
                                                <!-- Modal Hapus -->
                                                <div class="modal fade" id="modalHapus<?php echo $data['id_bks']; ?>" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body text-left">Anda yakin ingin menghapus data arsip
                                                                dokumen <strong><?php echo $data['nama_jenis']; ?></strong> Waktu
                                                                <strong><?php echo $data['tgl_upload']; ?></strong>?
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-default btn-round"
                                                                    data-dismiss="modal">Batal</button>
                                                                <a href="modules/bks/proses_hapus.php?id=<?php echo $data['id_bks']; ?>"
