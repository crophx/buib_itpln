                                            ...
                                            <div class="modal fade" id="modalUbahRealisasi<?php echo $data['id']; ?>" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="modules/training_center/proses_ubah.php" method="POST"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="kategori_tc<?php echo $data['id']; ?>"
                                                                                class="form-label font-weight-semibold">
                                                                                <i
                                                                                    class="fas fa-tags mr-1 text-success"></i>Kategori
                                                                                TC <span class="text-danger">*</span>
                                                                            </label>
                                                                            <select class="form-control"
                                                                                id="kategori_tc<?php echo $data['id']; ?>"
                                                                                name="kategori_tc" required>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="status_tc<?php echo $data['id']; ?>"
                                                                                class="form-label font-weight-semibold">
                                                                                <i
                                                                ...
                                                                <div class="alert alert-light border mt-3">
                                                                    ...
                                                                    <div class="row small">
                                                                        <div class="col-md-4">
                                                                            ...
                                                                            <span
                                                                                class="badge badge-primary"><?php echo htmlspecialchars($data['nama_kategori']); ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                            ...
                                            <div class="modal fade" id="modalHapusRealisasi<?php echo $data['id']; ?>" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body text-left">Anda yakin ingin menghapus data RK
                                                            training_center <strong><?php echo $data['nama_program']; ?></strong>
                                                            Tanggal
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="modules/training_center/proses_hapus.php?id=<?php echo $data['id']; ?>"
                                            ...
                                            <div class="modal fade" id="modalHapusTarget<?php echo $data['id']; ?>" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"><i class="fas fa-trash mr-2"></i>Hapus Data
                                                                Rencana Training Center</h5>
                                                        </div>
                                                        <div class="modal-body text-left">Anda yakin ingin menghapus data Rencana
                                                            Training Center<strong><?php echo $data['nama_program']; ?></strong>
                                                            Tanggal
                                                            <strong><?php echo date('d/m/Y', strtotime($data['tgl_surat'])); ?></strong>?
                                                        </div>
                                                        <div class="modal-footer">
