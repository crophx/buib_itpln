...
// jika user sudah login, maka jalankan perintah untuk insert
	...
	if (isset($_POST['simpan'])) {
		...
		$hak_akses = mysqli_real_escape_string($mysqli, $_POST['hak_akses']);
		...
		if ($rows <> 0) {
			// alihkan ke halaman pengguna dan tampilkan pesan gagal simpan data
		...
		// jika "username" belum ada di tabel "tbl_user"
			...
			if ($insert) {
				// alihkan ke halaman pengguna dan tampilkan pesan berhasil simpan data
